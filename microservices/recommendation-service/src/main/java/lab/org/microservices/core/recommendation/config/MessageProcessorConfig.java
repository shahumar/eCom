package lab.org.microservices.core.recommendation.config;
...
public class MessageProcessorConfig {
    public static final Logger LOG = LoggerFactory.getLogger(MessageProcessorConfig.class);
        ...
        return event -> {
            ...
            switch (event.getEventType()) {
                case CREATE:
                    ...
                    LOG.info("Create recommendation wiht ID: {}/{}", recommendation.getProductId(), recommendation.getRecommendationId());

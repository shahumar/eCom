...
public class MessagingTests {
    ...
    void createCompositeProduct1() {
        ProductAggregate composite = new ProductAggregate(1, "name", BigDecimal.ONE, null, null, null);
    ...
    void createCompositeProduct2() {
        ProductAggregate composite = new ProductAggregate(1, "name", BigDecimal.ONE,
